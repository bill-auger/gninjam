...
{  window_preferences = this;
   ...
   combobox_autosubscription = Gtk::manage(new class Gtk::ComboBox());
   treeview_autosubscription = Gtk::manage(new class Gtk::TreeView());
   
   Gtk::ScrolledWindow *scrolledwindow6 = Gtk::manage(new class Gtk::ScrolledWindow());
   Gtk::Button *button_autosubscription_add = Gtk::manage(new class Gtk::Button(Gtk::StockID("gtk-add")));
   Gtk::Button *button_autosubscription_delete = Gtk::manage(new class Gtk::Button(Gtk::StockID("gtk-remove")));
   Gtk::Button *button_autosubscription_clear = Gtk::manage(new class Gtk::Button(Gtk::StockID("gtk-clear")));
   Gtk::HBox *hbox8 = Gtk::manage(new class Gtk::HBox(true, 0));
   Gtk::VBox *vbox7 = Gtk::manage(new class Gtk::VBox(false, 4));
   Gtk::Label *label26 = Gtk::manage(new class Gtk::Label(_("Autosubscription")));
   ...
   combobox_autosubscription->set_name("combobox_autosubscription");
   treeview_autosubscription->set_name("treeview_autosubscription");
   treeview_autosubscription->set_flags(Gtk::CAN_FOCUS);
   treeview_autosubscription->set_headers_visible(false);
   treeview_autosubscription->set_rules_hint(false);
   treeview_autosubscription->set_reorderable(false);
   treeview_autosubscription->set_enable_search(true);
   ...
   scrolledwindow6->add(*treeview_autosubscription);
   button_autosubscription_add->set_name("button_autosubscription_add");
   button_autosubscription_add->set_flags(Gtk::CAN_FOCUS);
   button_autosubscription_add->set_relief(Gtk::RELIEF_NORMAL);
   button_autosubscription_delete->set_name("button_autosubscription_delete");
   button_autosubscription_delete->set_flags(Gtk::CAN_FOCUS);
   button_autosubscription_delete->set_relief(Gtk::RELIEF_NORMAL);
   button_autosubscription_clear->set_name("button_autosubscription_clear");
   button_autosubscription_clear->set_flags(Gtk::CAN_FOCUS);
   button_autosubscription_clear->set_relief(Gtk::RELIEF_NORMAL);
   hbox8->set_name("hbox8");
   hbox8->pack_start(*button_autosubscription_add, Gtk::PACK_SHRINK, 0);
   hbox8->pack_start(*button_autosubscription_delete, Gtk::PACK_SHRINK, 0);
   hbox8->pack_start(*button_autosubscription_clear, Gtk::PACK_SHRINK, 0);
   vbox7->set_name("vbox7");
   vbox7->set_border_width(4);
   vbox7->pack_start(*combobox_autosubscription, Gtk::PACK_SHRINK, 0);
   vbox7->pack_start(*scrolledwindow6);
   vbox7->pack_start(*hbox8, Gtk::PACK_SHRINK, 0);
   ...
   notebook1->pages().back().set_tab_label_packing(false, true, Gtk::PACK_START);
   notebook1->append_page(*vbox7, *label26);
   notebook1->pages().back().set_tab_label_packing(false, true, Gtk::PACK_START);
   ...
   table6->show();
   label24->show();
   combobox_autosubscription->show();
   treeview_autosubscription->show();
   scrolledwindow6->show();
   button_autosubscription_add->show();
   button_autosubscription_delete->show();
   button_autosubscription_clear->show();
   hbox8->show();
   vbox7->show();
   label26->show();
   notebook1->show();
   ...
   hbuttonbox1->show();
   vbox5->show();
   checkbutton_anonymous->signal_toggled().connect(sigc::mem_fun(*this, &window_preferences_glade::on_checkbutton_anonymous_toggled), false);
   button_autosubscription_add->signal_clicked().connect(sigc::mem_fun(*this, &window_preferences_glade::on_button_autosubscription_add_clicked), false);
   button_autosubscription_delete->signal_clicked().connect(sigc::mem_fun(*this, &window_preferences_glade::on_button_autosubscription_delete_clicked), false);
   button_autosubscription_clear->signal_clicked().connect(sigc::mem_fun(*this, &window_preferences_glade::on_button_autosubscription_clear_clicked), false);
   button_abort->signal_clicked().connect(sigc::mem_fun(*this, &window_preferences_glade::on_button_abort_clicked), false);
   button_apply->signal_clicked().connect(sigc::mem_fun(*this, &window_preferences_glade::on_button_apply_clicked), false);
   button_ok->signal_clicked().connect(sigc::mem_fun(*this, &window_preferences_glade::on_button_ok_clicked), false);
   window_preferences->signal_show().connect(sigc::mem_fun(*this, &window_preferences_glade::on_window_preferences_show), false);
}
