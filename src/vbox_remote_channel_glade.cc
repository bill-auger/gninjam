...
{  
   ...
   vbox_remote_channel->pack_start(*hseparator1, Gtk::PACK_SHRINK, 0);
   vbox_remote_channel->pack_start(*hbox4, Gtk::PACK_SHRINK, 0);
   vbox_remote_channel->pack_start(*hbox5);
   hseparator1->show();
   ...
   checkbutton_remote_receive->signal_toggled().connect(sigc::mem_fun(*this, &vbox_remote_channel_glade::on_checkbutton_remote_receive_toggled), false);
   combobox_remote_output->signal_changed().connect(sigc::mem_fun(*this, &vbox_remote_channel_glade::on_combobox_remote_output_changed), false);
   hscale_remote_volume->signal_value_changed().connect(sigc::mem_fun(*this, &vbox_remote_channel_glade::on_hscale_remote_volume_value_changed), false);
   hscale_remote_pan->signal_value_changed().connect(sigc::mem_fun(*this, &vbox_remote_channel_glade::on_hscale_remote_pan_value_changed), false);
   checkbutton_remote_mute->signal_toggled().connect(sigc::mem_fun(*this, &vbox_remote_channel_glade::on_checkbutton_remote_mute_toggled), false);
   checkbutton_remote_solo->signal_toggled().connect(sigc::mem_fun(*this, &vbox_remote_channel_glade::on_checkbutton_remote_solo_toggled), false);
   checkbutton_remote_stereo->signal_toggled().connect(sigc::mem_fun(*this, &vbox_remote_channel_glade::on_checkbutton_remote_stereo_toggled), false);
}
