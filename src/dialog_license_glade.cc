...
{  dialog_license = this;
   ...
   Gtk::Button *button_accept = Gtk::manage(new class Gtk::Button(Gtk::StockID("gtk-yes")));
   Gtk::Button *button_reject = Gtk::manage(new class Gtk::Button(Gtk::StockID("gtk-no")));
   textview2 = Gtk::manage(new class Gtk::TextView());
   
   Gtk::ScrolledWindow *scrolledwindow4 = Gtk::manage(new class Gtk::ScrolledWindow());
   Gtk::Label *label7 = Gtk::manage(new class Gtk::Label(_("You must agree to this license to connect to this server.")));
   ...
   dialog_license->set_title(_("License"));
