...
{  
   ...
   Gtk::Adjustment *spinbutton_bitrate_adj = Gtk::manage(new class Gtk::Adjustment(8, 8, 300, 1, 10, 10));
   spinbutton_bitrate = Gtk::manage(new class Gtk::SpinButton(*spinbutton_bitrate_adj, 1, 0));
   ...
   spinbutton_bitrate->set_name("spinbutton_bitrate");
   spinbutton_bitrate->set_flags(Gtk::CAN_FOCUS);
   _tooltips.set_tip(*spinbutton_bitrate, _("Bitrate"), "");
   spinbutton_bitrate->set_update_policy(Gtk::UPDATE_IF_VALID);
   spinbutton_bitrate->set_numeric(true);
   spinbutton_bitrate->set_digits(0);
   spinbutton_bitrate->set_wrap(false);
   ...
   hbox3->pack_start(*spinbutton_bitrate, Gtk::PACK_SHRINK, 0);
   ...
   spinbutton_bitrate->show();
   checkbutton_local_mute->show();
   checkbutton_local_solo->show();
   button_local_remove->show();
   hbox3->show();
   vbox_local_channel->show();
   entry_local_channelname->signal_changed().connect(sigc::mem_fun(*this, &vbox_local_channel_glade::on_entry_local_channelname_changed), false);
   checkbutton_local_transmit->signal_toggled().connect(sigc::mem_fun(*this, &vbox_local_channel_glade::on_checkbutton_local_transmit_toggled), false);
   combobox_local_input->signal_changed().connect(sigc::mem_fun(*this, &vbox_local_channel_glade::on_combobox_local_input_changed), false);
   hscale_local_volume->signal_value_changed().connect(sigc::mem_fun(*this, &vbox_local_channel_glade::on_hscale_local_volume_value_changed), false);
   hscale_local_pan->signal_value_changed().connect(sigc::mem_fun(*this, &vbox_local_channel_glade::on_hscale_local_pan_value_changed), false);
   spinbutton_bitrate->signal_value_changed().connect(sigc::mem_fun(*this, &vbox_local_channel_glade::on_spinbutton_bitrate_value_changed), false);
   checkbutton_local_mute->signal_toggled().connect(sigc::mem_fun(*this, &vbox_local_channel_glade::on_checkbutton_local_mute_toggled), false);
   checkbutton_local_solo->signal_toggled().connect(sigc::mem_fun(*this, &vbox_local_channel_glade::on_checkbutton_local_solo_toggled), false);
   button_local_remove->signal_clicked().connect(sigc::mem_fun(*this, &vbox_local_channel_glade::on_button_local_remove_clicked), false);
}
