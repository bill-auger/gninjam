...
{  
   ...
   hscale_volume->signal_value_changed().connect(sigc::mem_fun(*this, &RemoteUserFrame_glade::on_hscale_volume_value_changed), false);
   hscale_pan->signal_value_changed().connect(sigc::mem_fun(*this, &RemoteUserFrame_glade::on_hscale_pan_value_changed), false);
   checkbutton_mute->signal_toggled().connect(sigc::mem_fun(*this, &RemoteUserFrame_glade::on_checkbutton_mute_toggled), false);
}
